...
int main(int argc, char* argv[]){
	...
	HSVred_ranges.push_back(ThreeChannelRange(160, 179, 80, 255, 100, 255));
	HSVred_ranges.push_back(ThreeChannelRange(0, 25, 80, 255, 100, 255));
	...
	while (true) {
		...
		if (!stop){
			...
			case STOP_SEEK_FIRST_RED:
				...
				// Find Color
				findColor(hsv_image, red_detected, HSVred_ranges);
				//threshold
				threshold(red_detected, red_detected, 15, 255, CV_THRESH_BINARY);
